...
const NowPlaying = ({ songData }) => {
  return (
      <div className="inline-flex flex-col sm:flex-row w-full max-w-full truncate">
        <a href={songData?.item?.external_urls?.spotify} target={'_blank'} className="capsize text-gray-800 dark:text-gray-200 font-medium" rel="noreferrer">{songData.item?.name}</a>
